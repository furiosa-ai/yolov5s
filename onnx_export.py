...
def main():
    ...
    if model_repo == "ultralytics":
        ...
        #assert config and weights, "Config and Weight files are essential for converting openmmlab model!!"
...
def build_argument_parser():
    ...
    parser.add_argument('--config', type = str, default = "./datas/yolov5_s-v61_syncbn_fast_8xb16-300e_coco.py", help = "Path to config file to convert openmmlab torch model")
    parser.add_argument('--weights', type = str, default = "./datas/yolov5_s-v61_syncbn_fast_8xb16-300e_coco_20220918_084700-86e02187.pth", help = "Path to weight file to convert openmmlab torch model")
