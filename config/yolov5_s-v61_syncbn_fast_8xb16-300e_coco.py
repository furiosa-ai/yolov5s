# openmmlab config file - https://github.com/open-mmlab/mmyolo/tree/main/configs/yolov5
...
log_level = "INFO"
load_from = "../yolov5s_openmm/yolov5_s-v61_syncbn_fast_8xb16-300e_coco_20220918_084700-86e02187.pth"
resume = False
    ...
    dataset=dict(
        ...
        pipeline=[
            ...
            dict(
                ...
                pre_transform=[
                    dict(
                        type="LoadImageFromFile", file_client_args=dict(backend="disk")
                    ),
                    dict(type="LoadAnnotations", with_bbox=True),
                ],
            ),
