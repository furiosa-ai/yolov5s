...
def main():
    ...
    for image_name in tqdm(
        calib_data_names, desc="Calibrating", unit="image", mininterval=0.5
    ):
...
def build_argument_parser():
    ...
    parser.add_argument('--calib_count', default=10, type=int, help="How many images to use for calibration") # number of calibration data
